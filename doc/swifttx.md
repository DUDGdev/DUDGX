...
This mechanism has been integrated into Bitcore-Node-Dudgx which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Dudgx-Project/insight-api-Dudgx#web-socket-api](https://github.com/Dudgx-Project/insight-api-Dudgx#web-socket-api) 
* API: [https://github.com/Dudgx-Project/insight-api-Dudgx#swifttx-transactions](https://github.com/Dudgx-Project/insight-api-Dudgx#swifttx-transactions) 
...
By default, the Dudgx Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Dudgx Core daemon:

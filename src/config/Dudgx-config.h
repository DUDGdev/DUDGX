/* src/config/Dudgx-config.h.  Generated from Dudgx-config.h.in by configure.  */
/* src/config/Dudgx-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef DUDGX_CONFIG_H

#define DUDGX_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.dudgxlecoin.io.fr"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Dudgx Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Dudgx Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "Dudgx"

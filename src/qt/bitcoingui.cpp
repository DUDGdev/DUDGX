                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Dudgx Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Dudgx Core"), this);
    aboutAction->setStatusTip(tr("Show information about Dudgx Core"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Dudgx Core help message to get a list with possible Dudgx command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Dudgx Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("Dudgx Core"); // default title
